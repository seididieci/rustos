...
//!
//! Il processo `userfs` puo' usare queste istruzioni solo sulle porte abilitate
//! dalla sua I/O bitmap nel TSS per-processo (ADR-0006): ATA PIO 0x1F0-0x1F7,
//! 0x3F6-0x3F7. Ogni altra porta genera #GP.
