...
> corrente e' quello qui sotto (5/5 + 7/7 + 50/50 + shell) e in `AGENTS.md`.
...
testland/   test suite + repro + demo storiche
  ...
  usertests     usertests    — suite completa (50 test)          → PASS 50/50
  usertest-client usertestcli  — helper a modalita' (ECHO/ZEROREAD/NULLW/SRV/CHURN/KILLME/SRVDIE/SYNCWAIT/MNTDIE/OPENDIE/MAPHAMMER/FLOOD/NEST/FAULT_*/SHMDEMO/COWDEMO/FORKDEMO/ORPHAN/HARDEN)
...
## Cosa copre `usertests` (50 test; t34 per ultimo: i drop dei diritti sono
